...
public class MusicPlaybackService extends Service {
    ...
    private void updateRemoteControlClient(final String what) {
        ...
        if (ApolloUtils.hasJellyBeanMR2()
            ...
            mRemoteControlClient
                    ...
                    .putLong(MediaMetadataRetriever.METADATA_KEY_CD_TRACK_NUMBER, getQueuePosition() + 1)
    ...
    public String getGenreName() {
        synchronized (this) {
            ...
            Uri genreUri = MediaStore.Audio.Genres.getContentUriForAudioId("external", (int) mPlayList[mPlayPos]);
